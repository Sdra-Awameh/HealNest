...
<head>
    ...
    <title>HealNest - Login</title>    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="Assets/css/LoginPageStyle.css">
    <script src="Assets/js/notifications.js"></script>
    <script src="Assets/js/backend-conn.js"></script>
</head>
...
<body>
    <div class="login-container">
        ...
        </div>        <form method="post" id="login-form" action="Login-user-back.php">
            <?php
            session_start();
